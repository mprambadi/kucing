...
<head>
	...
	<script src="<?php echo base_url();?>assets/js/bootstrap.js" type="text/javascript">
	</script>
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="active">
						<a href="<?//php echo site_url('admin/data_pribadi'); ?>">
							<strong> Form Cek Kesehatan </strong>
						</a>
					</li>
					<li>
						<a href="<?//php echo site_url('welcome/custom'); ?>">
							<strong> Daftar Penyakit Pada Kucing </strong>
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('Kucing_controller/data_pasien_sebelumnya'); ?>">
							<strong> Data Pasien Sebelumnya </strong>
						</a>
					</li>
	...
	<h2 align="center"> ISI FORM BERIKUT! </h2>
	<br/>
	<div class="container">
		<div class="row">
			<div class="col-md-3">
