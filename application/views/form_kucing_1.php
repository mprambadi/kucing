			...
			<div class = "row">
				<div class = "row">
					<div class = "col-lg-5 col-centered">
						<form action = "<?php echo site_url('kucing_controller/proses_tambah_data_kucing_1');?>" method = "POST" class="form-horizontal">
						<div class = "form-body">
							<div class="form-group">
								<label class="control-label col-md-3">Pertanyaan</label>
								  <div class="col-md-9">
									...
									$i = 0;
									//var_dump($gejala_umum); 
									$jumlah = sizeof($gejala_umum);
									
									foreach($gejala_umum as $gejala){
										
										if($i==0){
											echo substr($gejala->daftar_pertanyaan, 0, -1) . " dan ";
										}else if($i==$jumlah-1){
											echo substr($gejala->daftar_pertanyaan, 7) ;
										}else{
											$a = substr($gejala->daftar_pertanyaan, 0, -1);
											$a = substr($a, 7) ;
											echo $a." dan ";
										}
									...
									<?php foreach($gejala_umum as $id_gejala){?>
										<input type="hidden" name="id_gejala_umum" value = "<?php echo $id_gejala->id_gejala_umum;?>">
									<?php }?>
